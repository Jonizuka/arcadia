      ...
      <nav class="navbar navbar-expand-md navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="n_bar">
          <ul class="navbar-nav">
            ...
            <li class="nav-item connexion"><a class="nav-link" href="./connexion.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
